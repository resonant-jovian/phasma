...
fn viridis(t: f64) -> (u8, u8, u8)   { interp_stops(&VIRIDIS_STOPS, t) }
fn inferno(t: f64) -> (u8, u8, u8)   { interp_stops(&INFERNO_STOPS, t) }
fn plasma(t: f64)  -> (u8, u8, u8)   { interp_stops(&PLASMA_STOPS,  t) }
fn magma(t: f64)   -> (u8, u8, u8)   { interp_stops(&MAGMA_STOPS,   t) }
fn cubehelix(t: f64) -> (u8, u8, u8) { interp_stops(&CUBEHELIX_STOPS, t) }
fn coolwarm(t: f64) -> (u8, u8, u8)  { interp_stops(&COOLWARM_STOPS, t) }
